...
O planejamento proposto é simples e fácil, garantindo o aprendizado e acompanhamento de todos da equipe no processo de desenvolvimento de cada funcionalidade.

Visamos o desenvolvimento paralelo do Frontend e Backend, alternando as responsabilidades entre os membros para aprendizado em conjunto.
...
Foco em preparar o ambiente de desenvolvimento e estruturar a base de dados.

1.  Iniciar a configuração inicial do software:
  
    Instalação das ferramentas base e ambiente.
    
    **Responsável**: Todos
    
5.  Iniciar o projeto de API (Backend):
...
## Sprint 2 - Autenticação e Conta de Usuário

Desenvolvimento das funcionalidades de acesso e gestão de perfil do usuário.

1.  Tela Inicial, Conta e Autenticação:
...
Implementação do "Core" do aplicativo: o registro e instrução de descarte.

1.  Registro de Descarte:
